...
A501,S001,ACTION,MONDAY,17:00,"Material Science: Bonding","Review ionic & covalent bonds",CHEMISTRY,DEEP_DIVE`;
  ...
  return (
    <div className={`fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4 backdrop-blur-sm ${animationClasses}`} onClick={handleClose}>
      <div className={`w-full max-w-2xl bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl shadow-2xl p-6 ${contentAnimationClasses}`} onClick={(e) => e.stopPropagation()}>
        ...
        <p className="text-sm text-gray-400 mb-4">Paste the schedule table (up to one month) generated by your AI assistant (like Gemini). Our AI will handle the rest.</p>
