...
User Input: "My AITS mock test is on Sunday at 9am, full syllabus. Also, I need to finish my maths homework (Ex 2.1, Qs 1-15) by Tuesday. By the way, I got 195/300 on my last test and my main mistakes were in Thermodynamics and P-Block elements."

AI-Generated CSV Output:
\`\`\`csv
ID,SID,TYPE,SUBJECT,TITLE,DATE,TIME,SYLLABUS
E501,,EXAM,FULL,"AITS Mock Test",2024-09-01,09:00,"Full Syllabus"
ID,SID,TYPE,DAY,TIME,CARD_TITLE,FOCUS_DETAIL,SUBJECT_TAG,Q_RANGES,SUB_TYPE
H502,,HOMEWORK,TUESDAY,,"Maths Homework","Complete exercises for the week.",MATHS,"Ex 2.1: 1-15",
SID,TYPE,SCORE,MISTAKES,WEAKNESSES
,,RESULT,"195/300","Thermodynamics;P-Block elements",
\`\`\`
---
...
\`\`\`csv
ID,SID,TYPE,SUBJECT,TITLE,DATE,TIME,SYLLABUS
E301,,EXAM,FULL,"Kota Major Test #1",2024-08-18,07:00,"Full Syllabus Paper 1"
E302,,EXAM,CHEMISTRY,"Organic Chemistry Test",2024-08-22,14:00,"Hydrocarbons,Aldehydes & Ketones"
\`\`\`
...
\`\`\`csv
SID,TYPE,SCORE,MISTAKES,WEAKNESSES
,RESULT,"185/300","Integration by Parts;Young's Double Slit",
,WEAKNESS,,"","Definite Integration;Wave Optics;Mole Concept"
\`\`\``;
