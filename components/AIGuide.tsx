...
The system can process multiple data types in a single CSV import. If a user provides text that describes both a new weekly task and an upcoming exam, you should generate CSV rows for BOTH schemas in your response.

**Multi-Schema Example:**
User Input: "My AITS mock test is on Sunday at 9am, full syllabus. Also, I need to finish my maths homework (Ex 2.1, Qs 1-15) by Tuesday."
